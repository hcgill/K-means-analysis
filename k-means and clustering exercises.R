...
wineMatrix = as.matrix(fit.km$cluster)

clusplot(pam(wineMatrix, 3), main = "Wines by Cluster", xlab = "Cluster Number")
clusplot(pam(wine, 3), main = "Wines by Type", xlab = "Type")
